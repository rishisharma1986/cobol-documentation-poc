...
FETCH-PAYMENT-INSTRUCTIONS.
    MOVE 'SELECT CUST_CTRY, CUST_INSTT, CUST_ID, INSTR_REF_NUM, AC_CTRY, AC_INSTT, AC_NO, AC_PROD_TYP, BENE_NAM, BENE_ADDR1, BENE_ADDR2, BENE_ADDR3, DEBTOR_NAME, DEBTOR_ADDR1, DEBTOR_ADDR2, DEBTOR_ADDR3, INSTR_PTY FROM PAYMENTS.PAYMENT_INSTRUCTIONS WHERE CUST_CTRY = ''US'' AND AC_CTRY = ''US'' AND AC_INSTT = ''12345'' AND AC_NO = ''1234567890123456'' AND AC_PROD_TYP = ''SAV'' ' TO WS-SQL-STATEMENT.
    EXEC SQL
        SELECT *
        INTO :WS-SQL-RESULT
